"""
Django settings for agent_44121 project.
...
WSGI_APPLICATION = 'agent_44121.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "agent_44121 API",
    "DESCRIPTION": "API documentation for agent_44121 App",
    "VERSION": "v1",
}
